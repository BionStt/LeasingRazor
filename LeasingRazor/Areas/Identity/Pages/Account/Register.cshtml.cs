...
namespace LeasingRazor.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
      ...
      //  private readonly IEmailSender _emailSender;
        ...
        public RegisterModel(SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager, IUserStore<ApplicationUser> userStore, IUserEmailStore<ApplicationUser> emailStore, ILogger<RegisterModel> logger, ApplicationSettings appsettings, IToastNotification toastNotification, IEmailService emailSender)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, Domain.EnumInEntity.Roles.Basic.ToString());
